...
if CFG_WEBSESSION_STORAGE == 'mysql':
    ...
    class MySQLInvenioSession(BaseInvenioSession):
        def __init__(self, req, sid=None):
            ...
            super(MySQLInvenioSession, self).__init__(req, sid)
    ...
    InvenioSession = MySQLInvenioSession


if CFG_WEBSESSION_STORAGE == 'redis':

    from invenio.redisutils import get_redis

    class RedisInvenioSession(BaseInvenioSession):
